                        ...
                        <div class="card">
                           ...
                           <?php
                              if(isset($_POST["submit"])){
                                ...
                                $sql = "INSERT INTO `project_catagory`(`category_name`) VALUES ('$category_name')";
                           ...
                           ?>
                               <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
                                 <h4 class="fs-4">Add Project Category</h4>
                                 <?php
                                    if(isset($success)){
                                 ?>
                                ...
                                <div class="mb-3 mt-3">
                                  ...
                                  <input type="text" class="form-control shadow-none" id="category" placeholder="Enter Category Name" name="category">
                                </div>
